...
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3Mi樺sIiwicmViIjoibm52dGVkaWJ1YnVpeWtvdnJ0Zml2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTIxOTk5MzQsImV4cCI6MjA2Nzc3NTkzNH0.s5-CtQuXYAf1hQcRwljYhROibzm9U65XGxtD7LJeNVU';
...
async function loadAndDisplayCompanyInfoFromDB() {
    console.log("Realtime triggered: Reloading company info from DB..."); // Debugging
    try {
        ...
        console.error("Error reloading company info via realtime:", e);
...
infoForm.addEventListener('submit', async (event) => {
    ...
    try {
        if (file) {
            ...
            console.log("Uploading file to storage:", fileName); // Debugging
            ...
            console.log("File uploaded, URL:", fileUrl); // Debugging
        }
        ...
        // loadCompanyInfoList(); // Dihapus karena akan digantikan oleh realtime
    } catch (e) {
