...
async function verifyUserAndLoadEmployee() {
    ...
    try {
        ...
        console.log("Logged in user email:", session.user.email); // Debugging
        ...
        console.log("Employee Data for leave form:", employeeData); // Debugging
        console.log("Employee Error for leave form:", employeeError); // Debugging

        if (employeeError) {
            console.error("Error fetching employee data for leave form:", employeeError);
        ...
        console.error("Caught error in verifyUserAndLoadEmployee:", e);
